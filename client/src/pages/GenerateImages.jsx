...
const GenerateImages = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const prompt = `Create an image of ${input} in ${selectedStyle} style.`;
          ...
          {imageStyle.map((item) => (
            <span
              ...
              className={`text-xs px-4 py-1 border rounded-full cursor-pointer 
                ${selectedStyle === item
                  ? 'bg-green-50 text-green-700 border-purple-300'
        ...
        </div>
        {
          !content ? (
            ...
            <div className='mt-3 h-full'>
              <img src={content} alt="Generated" className='w-full h-full object-cover rounded-md' />
            </div>
          )
        }
      </div>
